...
class ConstantFoldingTest : public ::testing::Test {
 protected:
  ...
  void TestPreserveOutputShapes() {
    ...
    decent_q::TransformFuncContext context;
  ...
  void TestConstantFolding(const GraphDef& graph_def,
    ...
    TF_ASSERT_OK(
        decent_q::FoldConstants(graph_def, context, &folded_graph_def));
  ...
  void TestReplaceSendRecvs() {
    ...
    TF_ASSERT_OK(decent_q::ReplaceSendRecvs(o_graph_def, n_graph_def,
                                            {"placeholder"}, {"a_const"},
                                            &result_graph_def));

    std::map<string, const NodeDef*> node_map;
    decent_q::MapNamesToNodes(result_graph_def, &node_map);
  ...
  void TestRemoveUnusedNodes() {
    ...
    TF_ASSERT_OK(root.ToGraphDef(&graph_def));
    GraphDef result_graph_def;
    TF_ASSERT_OK(decent_q::RemoveUnusedNodes(
