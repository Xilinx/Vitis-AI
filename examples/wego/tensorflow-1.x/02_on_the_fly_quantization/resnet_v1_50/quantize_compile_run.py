...
###########################
Q_INPUT_NODE = "input"
Q_OUTPUT_NODE = "resnet_v1_50/predictions/Reshape_1"
METHOD = 1
...
if __name__ == "__main__":
    ...
    input_graph_def = vitis_vai.quantize(input_frozen_graph=FLOAT_MODEL,
        input_nodes=Q_INPUT_NODE,
        input_shapes="?,%d,%d,3"%(INPUT_HEIGHT,INPUT_WIDTH),
