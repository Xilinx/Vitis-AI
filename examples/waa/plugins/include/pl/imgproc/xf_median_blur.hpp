...
void xFMedianProc(XF_CTUNAME(DEPTH, NPC) OutputValues[XF_NPIXPERCYCLE(NPC)],
...
void ProcessMedianNxN(xf::cv::Mat<TYPE, ROWS, COLS, NPC>& _src_mat,
					  ...
					  XF_CTUNAME(TYPE, NPC) OutputValues[XF_NPIXPERCYCLE(NPC)],
...
// clang-format off
                ...
                XF_CTUNAME(TYPE, NPC) OutputValues_percycle[XF_NPIXPERCYCLE(NPC)];
