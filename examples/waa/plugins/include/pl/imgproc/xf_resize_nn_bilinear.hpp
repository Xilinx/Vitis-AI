...
void interpolatePixel(XF_PTNAME(XF_DEPTH(DEPTH, NPPC)) A0,
                      ...
                      ap_ufixed<12, 2> Wx,
                      ap_ufixed<12, 2> Wy,
                      XF_PTNAME(XF_DEPTH(DEPTH, NPPC)) & pixel, int output_write_pointer) {
// clang-format off
    #pragma HLS inline
...
void computeOutputPixel(XF_TNAME(SRC_TYPE, NPPC) A0[NUMBEROFINPUTWORDS],
                        ...
                        XF_TNAME(SRC_TYPE, NPPC) & pixel, int output_write_pointer) {
// clang-format off
    #pragma HLS inline
    // clang-format on
...
// clang-format off
                #pragma HLS UNROLL
                // clang-format on
                unpackX1temp[l] = (XF_PTNAME(XF_DEPTH(SRC_TYPE, NPPC)))unpackX1[l].range((k + 1) * PIXELDEPTH - 1, k * PIXELDEPTH);
                unpackX2temp[l] = (XF_PTNAME(XF_DEPTH(SRC_TYPE, NPPC)))unpackX2[l].range((k + 1) * PIXELDEPTH - 1, k * PIXELDEPTH);
            }
            ...
            interpolatePixel<SRC_TYPE, INTERPOLATION_TYPE, NPPC>(
                ...
                currentoutput, output_write_pointer);
...
// clang-format off
            ...
            computeInterpolation<INTERPOLATION_TYPE, COMP_INDEX_WIDTH, COMP_INDEX_INT, INDEX_INT, SCALE_WIDTH,
                ...
                scaley, indexx, indexy, nextYScale, WeightX, WeightY, indexx_pre_comp, indexy_pre_comp, output_write_pointer);
...
// clang-format off
                    ...
                    computeOutputPixel<SRC_TYPE, INTERPOLATION_TYPE, NPPC, INDEX_INT, BUFFER_WORDS, WEIGHT_WIDTH,
                                       WEIGHT_INT>(P0Buf, P1Buf,
                                                   ...
                                                   WeightX, WeightY, temp_store_output,output_write_pointer);
