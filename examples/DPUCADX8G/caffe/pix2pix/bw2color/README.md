...
```
cd ${VAI_ALVEO_ROOT}/DPUCADX8G/caffe/pix2pix/bw2color
...
The Pix2Pix (B/W to color) model files would be located in '${VAI_ALVEO_ROOT}/DPUCADX8G/caffe/models/bw2color' folder.
...
```
cd ${VAI_ALVEO_ROOT}/DPUCADX8G/caffe/pix2pix/bw2color
cp -R ${VAI_ALVEO_ROOT}/DPUCADX8G/caffe/models/bw2color ./quantize_results
```
