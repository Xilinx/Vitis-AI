...
| FP32 Accuracy      | 0.7502/0.9215(top1/top5)                |
| INT8 Accuracy      | 0.7457/0.9187 (top1/top5)               |
...
1. Network Architecture: ResNet101
...
2. node information
  ...
  The name of output node: 'resnet_v1_101/predictions/Reshape_1'
  ```
