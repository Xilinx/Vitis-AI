...
| FP32 Accuracy      | 0.7568/0.9259(top1/top5)                |
| INT8 Accuracy      | 0.7550/0.9251 (top1/top5)               |
...
1. Network Architecture: ResNet152
...
2. node information
  ...
  ```
  The name of input node: 'input'
  The name of output node: 'resnet_v1_152/predictions/Reshape_1'
  ```
