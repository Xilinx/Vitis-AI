...
| FP32 Accuracy      | 0.582/0.805 (top1/top5)                 |
| INT8 Accuracy      | 0.581/0.805 (top1/top5)                 |
...
1. Network Architecture: SqueezeNet
 
2. Paper link: https://arxiv.org/abs/1602.07360
...
1. Evaluate float model
  ```shell
  bash run_test_v1.1_float.sh
  ```
2. Quant aware training 
  ```shell
  bash run_qat_v1.1.sh
  ```
3. Dump xmodel
  ```shell
  bash run_deploy_v1.1.sh
  ```
