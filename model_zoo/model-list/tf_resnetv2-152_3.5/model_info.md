...
| FP32 Accuracy      | 0.7779/0.9411(top1/top5)                |
| INT8 Accuracy      | 0.7432/0.9249(top1/top5)                |
...
1. Network Architecture: ResNet152V2
...
2. Node information
  ...
  The name of output node: 'resnet_v2_152/predictions/Reshape_1:0'
  ```
