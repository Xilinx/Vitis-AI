...
| FP32 Accuracy      | 0.7559/0.9283(top1/top5)                |
| INT8 Accuracy      | 0.7445/0.9244(top1/top5)               |
...
1. Network Architecture: ResNet50V2
...
2. Node information
  ...
  The name of output node: 'resnet_v2_50/predictions/Reshape_1:0'
  ```
