...
| FP32 Accuracy      | 0.8018/0.9519(top1/top5)                |
| INT8 Accuracy      | 0.8003/0.9510 (top1/top5)               |
...
1. Network Architecture: Inception-v4
...
2. Node information
  ...
  The name of output node: 'InceptionV4/Logits/Predictions:0'
  ```
