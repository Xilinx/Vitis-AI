...
| FP32 Accuracy      | 0.6976/0.8963 (top1/top5)               |
| INT8 Accuracy      | 0.6945/0.8962 (top1/top5)               |
...
1. Network Architecture: Inception-v1
...
1.  data preprocess
  ...
  center crop: 224 * 224
  input = (input/255.0 - 0.5) * 2.0
  ```
2. node information

  ```
  The name of input node: 'input:0'
  The name of output node: 'InceptionV1/Logits/Predictions/Reshape_1:0'
  ```
