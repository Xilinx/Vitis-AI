...
Please note that if the models are marked as limited to non-commercial use, then users need compliance with the [AMD license agreement for non-commercial models](/model_zoo/AMD-license-agreement-for-non-commercial-models.md) that also showed in model.yaml of [model-list](/model_zoo/model-list). 
