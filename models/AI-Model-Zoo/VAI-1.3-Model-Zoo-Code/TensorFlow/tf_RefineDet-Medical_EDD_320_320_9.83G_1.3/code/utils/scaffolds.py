...
def restore_variables(exclusion_scopes):
...
def rename_variables(variables_to_restore, name_remap):
    renamed_variables_to_restore = {}
    ...
    return renamed_variables_to_restore

def scaffold_init_fn(model_dir, checkpoint_path, model_scope, checkpoint_model_scope, checkpoint_exclude_scopes, ignore_missing_vars, name_remap=None):
    ...
    variables_to_restore = restore_variables(exclusion_scopes)

    if checkpoint_model_scope:
        ...
        if name_remap:
            variables_to_restore = rename_variables(variables_to_restore, name_remap)
