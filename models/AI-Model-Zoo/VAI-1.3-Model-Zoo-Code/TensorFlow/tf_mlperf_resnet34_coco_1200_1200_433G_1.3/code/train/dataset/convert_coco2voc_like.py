...
arg_parser.add_argument('-ti', '--train_images', type=str, default="../../data/coco2017/train2017", help='where to put coco2017 train images.')
arg_parser.add_argument('-vi', '--val_images', type=str, default='../../data/coco2017/val2017', help='where to put coco2017 val images.')
arg_parser.add_argument('-ta', '--train_anno', type=str, default='../../data/coco2017/instances_train2017.json', help='where to put cooc2017 train set annotations.')
arg_parser.add_argument('-va', '--val_anno', type=str, default='../../data/coco2017/instances_val2017.json', help='where to put coco2017 val set annotations')
arg_parser.add_argument('-tlf', '--tran_list_file', type=str, default='../../data/coco2017/train2017.txt', help='image list for training')
arg_parser.add_argument('-vlf', '--val_list_file', type=str, default='../../data/coco2017/val2017.txt', help='image list for evalution.')
arg_parser.add_argument('-ai', '--all_images', type=str, default='../../data/coco2017/Images', help='where to put all images.')
arg_parser.add_argument('-aa', '--all_anno', type=str, default='../../data/coco2017/Annotations', help='where to put all annotations.')
