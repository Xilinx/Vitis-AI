...
def clip_bboxes(xmin, ymin, xmax, ymax, name):
    with tf.name_scope(name, 'clip_bboxes', values=[xmin, ymin, xmax, ymax]):
...
def filter_bboxes(scores_pred, xmin, ymin, xmax, ymax, min_size, name):
    with tf.name_scope(name, 'filter_bboxes', values=[scores_pred, xmin, ymin, xmax, ymax]):
        width = xmax - xmin
        height = ymax - ymin
...
def sort_bboxes(scores_pred, xmin, ymin, xmax, ymax, keep_topk, name):
    with tf.name_scope(name, 'sort_bboxes', values=[scores_pred, xmin, ymin, xmax, ymax]):
