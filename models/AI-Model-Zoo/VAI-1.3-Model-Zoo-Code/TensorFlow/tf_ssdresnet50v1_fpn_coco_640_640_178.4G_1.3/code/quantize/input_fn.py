...
model_type = get_config(key="MODEL_TYPE", default_value="ssd_resnet50_v1_fpn")
...
input_height = int(get_config(key="INPUT_HEIGHT", default_value=640))
input_width = int(get_config(key="INPUT_WIDTH", default_value=640))
