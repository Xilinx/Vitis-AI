...
tf.app.flags.DEFINE_string(
    'model_type', 'ssd_inception_v2', 'Detection model type')
tf.app.flags.DEFINE_string(
...
class SSD(object):
  ...
  def __init__(self, params, input_graph):
    ...
    if FLAGS.use_quantize:
      self.box_encoding_tensor = params.box_encoding_tensor.replace(":", "/aquant:")
      self.class_score_tensor = params.class_score_tensor.replace(":", "/aquant:")
