...
#/opt/vitis_ai/conda/envs/vitis-ai-caffe/bin/caffe train -solver solver.prototxt -gpu 3 -weights $PRETRAIN_WEIGHTS
...
caffe_exec caffe train -solver solver.prototxt -gpu 3 -weights $PRETRAIN_WEIGHTS
