...
if __name__ == '__main__':
    ...
    print("quant_mode", FLAGS.quant_mode)
    print("dump_xmodel", FLAGS.dump_xmodel)
    ...
    user = User(ARCH, DATA, FLAGS.dataset, FLAGS.log, FLAGS.model,FLAGS.model_name,FLAGS.split,FLAGS.quant_mode,FLAGS.dump_xmodel,FLAGS.device)
    user.infer()
