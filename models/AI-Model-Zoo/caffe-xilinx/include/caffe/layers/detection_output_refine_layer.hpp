#ifndef CAFFE_DETECTION_OUTPUT_REFINE_LAYER_HPP_
#define CAFFE_DETECTION_OUTPUT_REFINE_LAYER_HPP_
...
class DetectionOutputRefineLayer : public Layer<Dtype> {
 public:
  explicit DetectionOutputRefineLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "DetectionOutputRefine"; }
