...
bool ReadSegImageToAnnotatedDatum(const string& filename,
    const string& labelname, const string& segname, const int height, const int width,
    const int min_dim, const int max_dim, const bool is_color,
    const std::string& encoding, const AnnotatedDatum_AnnotationType type,
    const string& labeltype, const std::map<string, int>& name_to_label,
    AnnotatedDatum* anno_datum);

inline bool ReadSegImageToAnnotatedDatum(const string& filename,
    const string& labelname, const string& segname, const int height, const int width,
    const bool is_color, const std::string & encoding,
    const AnnotatedDatum_AnnotationType type, const string& labeltype,
    const std::map<string, int>& name_to_label, AnnotatedDatum* anno_datum) {
  return ReadSegImageToAnnotatedDatum(filename, labelname, segname, height, width, 0, 0,
                      is_color, encoding, type, labeltype, name_to_label,
                      anno_datum);
}
...
bool ReadTxtOriToAnnotatedDatum(const string& labelname, const int height,
    const int width, const std::map<string,int>& name_to_label, AnnotatedDatum* anno_datum);
