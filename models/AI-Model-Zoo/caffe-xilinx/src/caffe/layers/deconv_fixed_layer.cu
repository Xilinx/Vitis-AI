...
void DeconvolutionFixedLayer<Dtype>::Forward_gpu(
...
template <typename Dtype>
void DeconvolutionFixedLayer<Dtype>::Backward_gpu(
    const vector<Blob<Dtype> *> &top, const vector<bool> &propagate_down,
    const vector<Blob<Dtype> *> &bottom) {

  DeconvolutionLayer<Dtype>::Backward_gpu(top, propagate_down, bottom);
}

INSTANTIATE_LAYER_GPU_FUNCS(DeconvolutionFixedLayer);
