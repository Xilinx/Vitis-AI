...
static cv::Mat
process_result_multitask(cv::Mat &m1, const xilinx::ai::MultiTaskResult &result,
                         bool is_jpeg) {
...
cv::Mat process_result_roadline(cv::Mat &image,
                                const xilinx::ai::RoadLineResult &result,
                                bool is_jpeg) {
      ...
      argc, argv,
      {
          [] {
            return xilinx::ai::create_dpu_filter(
                [] {
                  return xilinx::ai::MultiTask8UC3::create(
                      "multi_task");
                },
          ...
          [] {
            return xilinx::ai::create_dpu_filter(
                [] {
                  return xilinx::ai::RoadLine::create(
                      "vpgnet_pruned_0_99");
                },
