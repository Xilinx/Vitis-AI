...
void parseImage(xilinx::ai::TFSSD * tfssd, cv::Mat &img,
...
int main(int argc, char *argv[]) {
  ...
  auto tfssd = xilinx::ai::TFSSD::create(model_name, true);
...
void parseImage(xilinx::ai::TFSSD *tfssd, cv::Mat &img,
  ...
  for(auto &r: result.bboxes) {
      ...
      json_object_array_add(bbox_array, json_object_new_double(r.height * height));
