...
echo "The Cross Compiler will be installed in ~/petalinux_sdk_2020.2 by default"
install_path=~/petalinux_sdk_2020.2
...
echo "    source $install_path/environment-setup-aarch64-xilinx-linux"
