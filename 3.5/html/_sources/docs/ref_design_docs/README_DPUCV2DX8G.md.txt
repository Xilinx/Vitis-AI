...
The reference design associated with this document [is found here](https://www.xilinx.com/bin/public/openDownload?filename=DPUCV2DX8G_VAI_v3.5.tar.gz).
...
- [6 Instructions for Changing the Platform](#6-instructions-for-changing-the-platform)
	- [6.1 DPUCV2DX8G Ports](#61-dpucv2dx8g-ports)
	- [6.2 Changing the Platform](#62-changing-the-platform)
- [7 Instructions for Adding Other Kernels](#7-instructions-for-adding-other-kernels)
	- [7.1 RTL Kernel](#71-rtl-kernel)
...
The Xilinx Versal Deep Learning Processing Unit (DPUCV2DX8G) is a computation engine optimized for convolutional neural networks.
...
```
**Note:** For running other networks, refer to the [Vitis AI Github](https://github.com/Xilinx/Vitis-AI) and [Vitis AI User Guide](https://docs.xilinx.com/r/en-US/ug1414-vitis-ai).
...
After changing '$TRD_HOME/vitis_prj/xv2dpu_config.mk', type 'make all' to build the design. 
