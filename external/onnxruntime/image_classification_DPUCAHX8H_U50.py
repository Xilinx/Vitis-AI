...
Vitis AI documentation for ONNX Runtime is available here:

https://www.onnxruntime.ai/docs/reference/execution-providers/Vitis-AI-ExecutionProvider.html
...
# SETUP
#
# 1. Follow setup instructions in the ONNX Runtime github repo
#    to setup the ONNX Runtime - Vitis AI environment:
#    https://www.onnxruntime.ai/docs/reference/execution-providers/Vitis-AI-ExecutionProvider.html
...
vitis_ai_provider_options = {'target': target, 'load_runtime_module': 'vitis_ai_dpucahx8h.rtmod'}
