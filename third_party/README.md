...
Vitis AI Execution Provider support has been integrated as an [experimental flow](onnxruntime) in recent releases.
...
Vitis AI Delegate support has been integrated as an [experimental flow](tflite) in recent releases.
