...
AKS_GRAPH_META_URL="https://www.xilinx.com/bin/public/openDownload?filename=meta_dk_yolov3_dpucadf8h_tvm_v2.5.0.zip"
NAME="graph_zoo/meta_yolov3_dpucadf8h_tvm"
if [[ ! -d "${NAME}" ]]; then
...
./examples/bin/yolov3_dpucadf8h_tvm.exe $DIRECTORY
