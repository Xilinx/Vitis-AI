...
class TestSoftmaxG : public ::testing::Test {
 ...
 protected:
  ...
  float scale = 0.5;
  float input_float[14]{-2, -1, 0.5, 2, 3, 5, 7,
      1, 1.5, 5, 2, 3, 6, 7};
  float output_gt[14]{1.06172563e-4, 2.88606949e-4, 1.29344661e-3,
      5.79682553e-3, 0.0157574055, 0.116432353, 0.86032519,
      0.001615, 0.00266268, 0.08817585, 0.00439002,
      0.0119333, 0.23968682, 0.65153633};
};
