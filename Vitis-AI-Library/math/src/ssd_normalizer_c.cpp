...
SSDNormalizer::SSDNormalizer(bool across_spatial, bool channel_shared,
    ...
    : across_spatial_(across_spatial), channel_shared_(channel_shared),
      height_(height), width_(width), channel_(channel),
      output_fix_pos_(output_fix_pos), eps_(eps), scale_(nullptr),
      norm_buf_(nullptr), scale_buf_(nullptr) {
