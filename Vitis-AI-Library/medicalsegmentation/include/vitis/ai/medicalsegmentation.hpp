 ...
 * @image latex images/sample_medicalsegmentation_result.jpg "detection result" width=\textwidth
 */
...
public:
   ...
   *
   */
  static std::unique_ptr<MedicalSegmentation> create(const std::string &model_name,
...
public:
   ...
   *
   */
  virtual std::vector<vitis::ai::MedicalSegmentationResult> run(const std::vector<cv::Mat> &img) = 0;
