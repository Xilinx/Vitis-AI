...
CXX=${CXX:-g++}
$CXX -std=c++11 -I. -o test_accuracy_platenum test_accuracy_platenum.cpp -lopencv_core -lopencv_video -lopencv_videoio -lopencv_imgproc -lopencv_imgcodecs -lopencv_highgui -lvitis_ai_library-platenum  -lvitis_ai_library-model_config -lvitis_ai_library-math -lglog 
