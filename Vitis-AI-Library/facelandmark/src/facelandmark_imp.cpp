...
FaceLandmarkImp::FaceLandmarkImp(const std::string &model_name, bool need_preprocess)
        : vitis::ai::TConfigurableDpuTask<FaceLandmark>(
              model_name, need_preprocess) {
}
...
std::vector<FaceLandmarkResult> FaceLandmarkImp::run(const std::vector<cv::Mat> &input_images) {
