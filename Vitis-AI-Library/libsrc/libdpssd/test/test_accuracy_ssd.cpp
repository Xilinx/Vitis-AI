...
int main(int argc, char *argv[]) {
  ...
  /*std::map<std::string, std::string> typemap{
      {"ADAS_VEHICLE_V3_480x360", xilinx::ai::SSD_ADAS_VEHICLE_V3_480x360},
      {"TRAFFIC_480x360", xilinx::ssd::TRAFFIC_480x360},
      {"ADAS_PEDESTRIAN_640x360", xilinx::ssd::ADAS_PEDESTRIAN_640x360},
      {"MOBILENET_V2_480x360", xilinx::ssd::MOBILENET_V2_480x360},
      {"VOC_300x300_TF", xilinx::ssd::VOC_300x300_TF}};
  */
  ...
  if (argc != 3) {
    cerr << "usage: test_ssd_accuracy model_type file_list_file_name " << endl
         ...
         << "   ssd_adas_vehicle_v3_480x360" << endl
         << "   ssd_traffic_480x360" << endl
         << "   ssd_adas_pedestrian_640x360" << endl
         << "   ssd_mobilenet_480x360" << endl
         << "   ssd_mobilenet_v2_480x360" << endl
         << "   ssd_voc_300x300_tf" << endl;
    return -1;
  }

  auto ssd = xilinx::ai::SSD::create(argv[1], true);
