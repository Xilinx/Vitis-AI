...
class DpuTask {
 ...
 public:
   ...
   */
  virtual std::vector<xilinx::ai::InputTensor> getInputTensor(size_t idx) = 0;
  /**
   * @brief Get the output tensors.
   * @return The output tensors.
   */
  virtual std::vector<xilinx::ai::OutputTensor> getOutputTensor(size_t idx) = 0;
  /**
   * @brief get the number of tasks
   * */
  virtual size_t get_num_of_tasks() const = 0;
  /**
