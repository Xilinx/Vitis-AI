...
static void DrawLines(cv::Mat &img,
                      const xilinx::ai::PoseDetectResult::Pose14Pt &results);

int main(int argc, char *argv[]) {
  auto det = xilinx::ai::PoseDetect::create(argv[1]);
  ...
  /*for (auto result : results.coords[0]) {
