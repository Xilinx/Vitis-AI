...
/**
 * @brief Base class for detecting and recognizing plate in a vehicle image (cv::Mat).
 *
...
class PlateRecog {
  public:
  /**
    * @brief Factory function to get a instance of derived classes of class PlateRecog
    *
    * @param need_mean_scale_process normalize with mean/scale or not, true by default
    *
    * @returen A PlateRecog class Instance
    */
    static std::unique_ptr<PlateRecog> create(const std::string &platedetect_model,
  ...
  /**
   * @brief Function to get InputWidth of the platerecog network (input image cols).
   *
  ...
  /**
   *@brief Function to get InputHeigth of the platerecog network (input image rows).
   *
