...
std::unique_ptr<Segmentation> Segmentation::create(const std::string& model_name, bool need_preprocess) {
...
std::unique_ptr<Segmentation8UC1> Segmentation8UC1::create(const std::string& model_name, bool need_preprocess) {
...
std::vector<SegmentationResult> Segmentation8UC1::run(const std::vector<cv::Mat>& images) {
    return segmentation_->run_8UC1(images);
}

std::unique_ptr<Segmentation8UC3> Segmentation8UC3::create(const std::string& model_name, bool need_preprocess) {
...
std::vector<SegmentationResult> Segmentation8UC3::run(const std::vector<cv::Mat>& images) {
