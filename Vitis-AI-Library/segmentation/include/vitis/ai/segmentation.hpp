...
class Segmentation {
 ...
 public:
   ...
   *
   */
  virtual std::vector<SegmentationResult> run_8UC1(const std::vector<cv::Mat>& images) = 0;
  /**
   * @brief Function to get running result of the segmentation network.
   *
   ...
   *
   */
  virtual std::vector<SegmentationResult> run_8UC3(const std::vector<cv::Mat>& images) = 0;
};
