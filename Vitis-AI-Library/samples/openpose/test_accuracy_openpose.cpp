...
using PosePoint = xilinx::ai::OpenPoseResult::PosePoint;

void parseImage(xilinx::ai::OpenPose *openpose, cv::Mat &img,
...
int main(int argc, char *argv[]) {
  ...
  auto openpose = xilinx::ai::OpenPose::create("openpose_pruned_0_3");
