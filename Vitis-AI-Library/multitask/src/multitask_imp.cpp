...
std::vector<MultiTaskResult> MultiTaskImp::run_8UC1(const std::vector<cv::Mat>& input_images) {
  run_it(input_images);
...
std::vector<MultiTaskResult> MultiTaskImp::run_8UC3(const std::vector<cv::Mat>& input_images) {
  run_it(input_images);
