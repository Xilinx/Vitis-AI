#ifndef CAFFE_MULTIBOX_LOSS_REFINE_LAYER_HPP_
#define CAFFE_MULTIBOX_LOSS_REFINE_LAYER_HPP_
...
class MultiBoxLossRefineLayer : public LossLayer<Dtype> {
 public:
  explicit MultiBoxLossRefineLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "MultiBoxLossRefine"; }
