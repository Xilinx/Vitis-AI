...
def parse_args():
    ...
    parser.add_argument('--data-root', '-d', type=str,
            default='/group/modelzoo/test_dataset/coco/coco2014/Images/',
            help='path to validation images')
    parser.add_argument('--image-list', '-i', type=str,
            default='/group/modelzoo/test_dataset/coco/coco2014/val2014.txt',
            help='path to image list file')
    parser.add_argument('--anno-root', '-a', type=str,
            default='/group/modelzoo/test_dataset/coco/coco2014/Annotations',
