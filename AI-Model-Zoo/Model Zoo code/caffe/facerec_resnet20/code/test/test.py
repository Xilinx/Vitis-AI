...
parser.add_argument('--caffe_path', type=str, default='../../../../../caffe-xilinx/python',
...
parser.add_argument('--testset_ID_list', type=str, default='testsetname_ID.txt',
                    help='ID list file')
parser.add_argument('--testset_Life_list', type=str, default='testsetname_Life.txt',
                    help='Snapshot photo list file')
parser.add_argument('--gpu', type=int, default=0,
                    help='gpu card for test')
parser.add_argument('--batch_size', type=int, default=64,
                    help='batch size for test')
parser.add_argument('--feat_name', type=str, default='Addmm_1',
...
if __name__ == "__main__":
    ...
    testImgListID=args.testset_ID_list
    testImgListLife=args.testset_Life_list
