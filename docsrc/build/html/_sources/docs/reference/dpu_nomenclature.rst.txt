...
There are a variety of different DPUs available for different tasks and Xilinx platforms. The following decoder is useful to extract the features, characteristics and target hardware platforms from a given DPU name.
