...
-  The Vitis AI Library quick start guide and open-source is `here <https://github.com/Xilinx/Vitis-AI/tree/v3.5/src/vai_library>`__.
...
-  A quick-start example to assist you in deploying VART on embedded devices is available `here <https://github.com/Xilinx/Vitis-AI/tree/v3.5/src/vai_runtime/quick_start_for_embedded.md>`__.

-  The Vitis AI Runtime is also provided as `open-source <https://github.com/Xilinx/Vitis-AI/tree/v3.5/src>`__.
...
-  Examples and additional detail for the Vitis AI Profiler can be found
   `here <https://github.com/Xilinx/Vitis-AI/tree/v3.5/examples/vai_profiler>`__.
