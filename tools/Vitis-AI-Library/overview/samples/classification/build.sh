...
$CXX -std=c++11 -I. -o test_accuracy_classification_mt test_accuracy_classification_mt.cpp -lopencv_core -lopencv_video -lopencv_videoio -lopencv_imgproc -lopencv_imgcodecs -lopencv_highgui -lvitis_ai_library-classification  -lvitis_ai_library-model_config -lglog -lpthread 
...
$CXX -std=c++11 -I. -o test_jpeg_classification test_jpeg_classification.cpp -lopencv_core -lopencv_video -lopencv_videoio -lopencv_imgproc -lopencv_imgcodecs -lopencv_highgui -lxnnpp-xnnpp -lvitis_ai_library-classification  -pthread -lglog 
$CXX -std=c++11 -I. -o test_jpeg_classification_cifar test_jpeg_classification_cifar.cpp -lopencv_core -lopencv_video -lopencv_videoio -lopencv_imgproc -lopencv_imgcodecs -lopencv_highgui -lvitis_ai_library-classification  -pthread -lglog 
...
$CXX -std=c++11 -I. -o test_video_classification test_video_classification.cpp -lopencv_core -lopencv_video -lopencv_videoio -lopencv_imgproc -lopencv_imgcodecs -lopencv_highgui -lxnnpp-xnnpp -lvitis_ai_library-classification  -pthread -lglog 
