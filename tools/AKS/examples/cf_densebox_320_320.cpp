...
{  
  ...
  if (cf_densebox_320_320.find(device) == cf_densebox_320_320.end()) {
  ...
  /// Load graph
  sysMan->loadGraphs(cf_densebox_320_320[device].second);

  /// Get graph instance
  AKS::AIGraph *graph = sysMan->getGraph(cf_densebox_320_320[device].first);
