...
if [[ $distroname == *"Ubuntu 16.04"* ]]; then
  ...
  sudo apt install ./*-u50lv-*validate*16.04.deb -y
  sudo apt install ./*-u50lv-*base*16.04.deb -y
elif [[ $distroname == *"Ubuntu 18.04"* ]]; then
  sudo apt install ./*cmc*18.04.deb -y
  sudo apt install ./*sc-fw*18.04.deb -y
  sudo apt install ./*-u50lv-*validate*18.04.deb -y
  sudo apt install ./*-u50lv-*base*18.04.deb -y
