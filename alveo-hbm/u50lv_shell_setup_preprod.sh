...
if [[ $distroname == *"Ubuntu 16.04"* ]]; then
  ...
  sudo apt install ./*-u50lv-*validate*16.04.deb -y --allow-downgrades
  sudo apt install ./*-u50lv-*base*16.04.deb -y --allow-downgrades
  ...
  sudo apt install ./*-u50lv-*validate*18.04.deb -y --allow-downgrades
  sudo apt install ./*-u50lv-*base*18.04.deb -y --allow-downgrades
elif [[ $distroname == *"CentOS"* ]] || [[ $distroname == *"RHEL"* ]]; then
  sudo yum install ./*cmc*.rpm -y
  sudo apt install ./*sc-fw*.rpm -y
  sudo apt install ./*-u50lv-*validate*.rpm -y
  sudo apt install ./*-u50lv-*base*.rpm -y
fi
