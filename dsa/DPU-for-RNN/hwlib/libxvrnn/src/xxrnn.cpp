    ...
    char *out, uint64_t osize)
{
    ...
    //for(int ii = 0; ii < 1; ii++){
      ...
      ecmd->data[0x0000001c / 4] = 0x0b000000;
      ecmd->data[0x00000020 / 4] = 0x000000c0;
      ecmd->data[0x00000024 / 4] = 0x00000000;
      ecmd->data[0x00000028 / 4] = 0x05000000;
      ecmd->data[0x0000002c / 4] = 0x000000c0;
      ecmd->data[0x00000030 / 4] = 0x06000000;
      ecmd->data[0x00000034 / 4] = 0x0a000000;
      ecmd->data[0x00000038 / 4] = 0x000000c0;
