...
int main() {
    ...
    double sigma = 0.068963597413997324;
    double x0 = 0.18580295883843218;
    double theta = 0.10177935032500834;
    double k = 0.10220445840674211;
    double rates[LEN];
