...
void dut(int n, int k, hls::stream<DT>& inStrm, hls::stream<DT>& outStrm);
...
int main() {
    ...
    DT goldenMat[N][N] = {{8.271590, -1.073140, 0.773794, 0.878236, 0.000000, 0.000000},
                          {-1.073140, 8.122960, 0.694735, -0.719803, 1.485100, 0.000000},
                          {0.773794, 0.694735, 8.797390, -0.994484, 0.248038, -0.395920},
                          {0.878236, -0.719803, -0.994484, 8.346660, 0.318372, -0.353867},
                          {0.000000, 1.485100, 0.248038, 0.318372, 7.871270, 0.676107},
                          {0.000000, 0.000000, -0.395920, -0.353867, 0.676107, 8.809560}};
