...
void hcf_kernel(struct xf::fintech::hcfEngineInputDataType<TEST_DT>* in, TEST_DT* out, int num_tests) {
...
#pragma HLS DATA_PACK variable = in
    ...
    struct xf::fintech::hcfEngineInputDataType<TEST_DT> local_in[MAX_NUMBER_TESTS];
