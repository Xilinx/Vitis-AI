...
#ifndef __CL_ERRCODE__
#define __CL_ERRCODE__
...
const char* clGetErrorString(int errorCode) {
    switch (errorCode) {
        ...
        case -20:
            return "CL_XILINX_UNIMPLEMENTED";
        case -1000:
 ...
 */
int clCheckError(int errorCode, const char* msg = NULL) {
    const char* s = "";
    if (msg == NULL) {
        msg = s;
    }
    if (errorCode != 0) {
        fprintf(stderr, "%s%s\n", clGetErrorString(errorCode), msg);
    }
    return errorCode;
}

#endif /* __CL_ERRCODE__*/
