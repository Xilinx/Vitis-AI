...
extern "C" void gqe_merge_kernel_3(ap_uint<2 * (DATA_WIDTH + KEY_WIDTH)>* inBuff,
...
#pragma HLS interface s_axilite port = return bundle = control
    ...
    xf::database::mergeSortKernel<ap_uint<DATA_WIDTH>, ap_uint<KEY_WIDTH>, CH_NUM_1, BURST_LEN, DATA_WIDTH, KEY_WIDTH>(
