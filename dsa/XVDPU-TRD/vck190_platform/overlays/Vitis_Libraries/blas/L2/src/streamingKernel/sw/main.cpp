...
std::vector<DdrType> loadBinFile(std::string p_BinFileName) {
...
bool writeBinFile(std::string p_BinFileName, std::vector<DdrType>& p_MemVec) {
    bool ok = false;
...
int main(int argc, char** argv) {
    ...
    // Load the bin file
    std::vector<DdrType> l_memVec[BLAS_numKernels];
