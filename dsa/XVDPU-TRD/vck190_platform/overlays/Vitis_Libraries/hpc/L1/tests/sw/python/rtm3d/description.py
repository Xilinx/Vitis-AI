...
class Description:
    def __init__(self, desPath):
        ...
        self.description['top'] = {
            "source": ["${XF_PROJ_ROOT}/L1/tests/hw/top.cpp"],
            "cflags": "-I${CUR_DIR} -I${XF_PROJ_ROOT}/L1/include/hw -I${XF_PROJ_ROOT}/L2/include/hw/rtm3d -I${XF_PROJ_ROOT}/../xf_blas/L1/include/hw"}
        self.description['testbench'] = {
            "source": ["${CUR_DIR}/../../main.cpp"],
            "cflags": "-std=c++14 -I${CUR_DIR} -I${XF_PROJ_ROOT}/L1/include/hw -I${XF_PROJ_ROOT}/../xf_blas/L1/include/hw -I${XF_PROJ_ROOT}/../xf_blas/L1/tests/sw/include",
            "ldflags": "",
            "argv": {
