...
set HOST_ARGS [file normalize "$ROOT_DIR/L1/tests/hw/forward_domain_hbc/data"]

open_project "hls_prj" -reset
set_top top 
add_files forward.cpp -cflags "$CFLAGS_K"
add_files -tb main.cpp -cflags "$CFLAGS_H"
open_solution sol -reset -flow_target vitis
