...
#CXXFLAGS += -D MLP_TANSIG=1
#activation = tansig

#MACROS += -D MLP_RELU=1
#CXXFLAGS += -D MLP_RELU=1
#activation = relu
...
CXXFLAGS += -D BLAS_numKernels=$(BLAS_numKernels) \
            -D BLAS_gemmMBlocks=$(BLAS_gemmMBlocks) \
            -D BLAS_gemmKBlocks=$(BLAS_gemmKBlocks) \
            -D BLAS_gemmNBlocks=$(BLAS_gemmNBlocks) \
            -D BLAS_ddrWidth=$(BLAS_ddrWidth) \
...
data_gen: 
	python $(XFLIB_DIR)/L2/src/python/mlp/data_gen.py --model 1 --batch 64 --activation $(activation)
