...
int main(int argc, const char* argv[]) {
    ...
    int info;
    info = computeSimilarity(xclbinPath, goldenFile, numVertices, numEdges, similarityType, dataType, sourceID, sortK,
                             repInt, numVerticesPU, numEdgesPU, offset32, indice32, weightSparse, sourceNUM,
                             sourceIndice, sourceWeight);
