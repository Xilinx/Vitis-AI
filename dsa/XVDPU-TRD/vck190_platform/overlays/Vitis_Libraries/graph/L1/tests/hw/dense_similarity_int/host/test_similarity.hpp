...
void generateSourceParams(unsigned int numVerticesPU[PU_NUMBER],
    ...
    *sourceWeight = aligned_alloc<ap_int<32> >(65536);
    ...
    for (int i = 0; i < sourceNUM; i++) {
        sourceWeight[0][i] = floatToBits<float, int32_t>(weightDense[id][row * numEdges + i]);
...
int computeSimilarity(std::string xclbinPath,
    ...
    denseSimilarityKernel(config[0], sourceWeight, (ap_int<32 * CHANNEL_NUMBER>*)weightDense[0],
                          (ap_int<32 * CHANNEL_NUMBER>*)weightDense[1], (ap_int<32 * CHANNEL_NUMBER>*)weightDense[2],
                          (ap_int<32 * CHANNEL_NUMBER>*)weightDense[3], (ap_int<32 * CHANNEL_NUMBER>*)weightDense[4],
                          (ap_int<32 * CHANNEL_NUMBER>*)weightDense[5], (ap_int<32 * CHANNEL_NUMBER>*)weightDense[6],
                          (ap_int<32 * CHANNEL_NUMBER>*)weightDense[7], (ap_int<32 * CHANNEL_NUMBER>*)weightDense[8],
                          (ap_int<32 * CHANNEL_NUMBER>*)weightDense[9], (ap_int<32 * CHANNEL_NUMBER>*)weightDense[10],
                          (ap_int<32 * CHANNEL_NUMBER>*)weightDense[11], (ap_int<32 * CHANNEL_NUMBER>*)weightDense[12],
                          (ap_int<32 * CHANNEL_NUMBER>*)weightDense[13], (ap_int<32 * CHANNEL_NUMBER>*)weightDense[14],
                          (ap_int<32 * CHANNEL_NUMBER>*)weightDense[15], result_id[0], similarity[0]);
