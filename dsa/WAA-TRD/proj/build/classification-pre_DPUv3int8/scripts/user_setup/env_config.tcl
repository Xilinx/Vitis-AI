...
regexp {build/classification-pre_DPUv3int8} $loc script_dir
set SDA_PATH "[string range $loc -1 [expr [string first $script_dir $loc] -1 ] ]build/classification-pre_DPUv3int8"
