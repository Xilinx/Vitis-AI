...
```
% cd $TRD_HOME/proj/build/classification-pre_DPUv2_jpeg
% ./build_classification_pre_jpeg.sh
```
Note that 
- Generated SD card image will be here **$TRD_HOME/proj/build/classification-pre_DPUv2_jpeg/binary_container_1/sd_card.img**.
- The default setting of DPU is **B4096** with RAM_USAGE_LOW, CHANNEL_AUGMENTATION_ENABLE, DWCV_ENABLE, POOL_AVG_ENABLE, RELU_LEAKYRELU_RELU6, Softmax. Modify the `$TRD_HOME/proj/build/classification-pre_DPUv2_jpeg/dpu_conf.vh` file can change the default settings.
