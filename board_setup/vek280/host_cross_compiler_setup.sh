...
echo "The Cross Compiler will be installed in ~/petalinux_sdk_2023.1 by default"
install_path=~/petalinux_sdk_2023.1
...
echo $install_path|./sdk-2023.1.0.0.sh

rm -r $install_path/sysroots/cortexa72-cortexa53-xilinx-linux/usr/share/cmake/XRT/

tar -xzvf vitis_ai_2023.1-r3.5.0.tar.gz -C $install_path/sysroots/cortexa72-cortexa53-xilinx-linux/
