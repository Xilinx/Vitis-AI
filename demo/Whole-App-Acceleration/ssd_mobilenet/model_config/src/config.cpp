...
static bool merge_file(const string &filename, vitis::ai::proto::DpuModelParamList *list);
...
find(const std::string &model_name) {
  ...
  // never goes here
  {
    // static auto v = vitis::ai::proto::TrainEvalPipelineConfig{};  // suppression
    // warning
    assert(false);
    return nullptr;
  }
...
extern "C" vitis::ai::proto::DpuModelParam 
get_config(const std::string &model_name) {
