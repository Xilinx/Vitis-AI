...
int main(int argc, char *argv[]) {
  ...
  for (auto batch_idx = 0u; batch_idx < results_show.size(); batch_idx++) {
    resize(results_show[batch_idx].positive_classification,
           results_show[batch_idx].positive_classification,
           cv::Size{results_show[batch_idx].width,
                    results_show[batch_idx].height});
    resize(results_show[batch_idx].infected_area_classification,
           results_show[batch_idx].infected_area_classification,
           cv::Size{results_show[batch_idx].width,
                    results_show[batch_idx].height});
