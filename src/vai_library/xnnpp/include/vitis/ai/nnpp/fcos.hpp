...
/**
 *@struct FCOSResult
 *@brief Struct of the result returned by the FCOS neural network.
 */
struct FCOSResult {
  /**
   *@struct BoundingBox
...
/**
 *@brief Post-process of the FCOS neural network in batch mode.
 ...
 *@return The vector of struct of FCOSResult.
 */
