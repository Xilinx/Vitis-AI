...
class TensorBufferProxy : public vart::TensorBuffer {
 public:
  explicit TensorBufferProxy(vart::TensorBuffer* tb, const xir::Tensor* tensor);
  virtual ~TensorBufferProxy();

 public:
  void update_backend(vart::TensorBuffer* tb) { real_ = tb; }
