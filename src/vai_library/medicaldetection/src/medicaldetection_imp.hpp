 ...
 */
#ifndef DEEPHI_MedicalDetection_HPP_
#define DEEPHI_MedicalDetection_HPP_
...
class MedicalDetectionImp : public vitis::ai::TConfigurableDpuTask<MedicalDetection> {
public:
  MedicalDetectionImp(const std::string &model_name, bool need_preprocess = true);
  virtual ~MedicalDetectionImp();
