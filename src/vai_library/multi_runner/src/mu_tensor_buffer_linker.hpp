...
class MUTensorBufferLinker {
 public:
  static std::unique_ptr<MUTensorBufferLinker> create(
      std::unique_ptr<vart::TensorBuffer>* tb);
  explicit MUTensorBufferLinker(std::unique_ptr<vart::TensorBuffer>* master);
  virtual ~MUTensorBufferLinker();
