...
class SeparableConv2D(Operation):
  ...
  @unique
  class ParamName(AutoName):
    DEPTHWISE_WEIGHT = auto()
    POINTWISE_WEIGHT = auto()
    BIAS = auto()
  ...
  def __init__(self, *args, **kwargs) -> None:
    ...
    self._attr_value_mem = {
        ...
        self.AttrName.PAD: [None, None, None, None],
        self.AttrName.GROUP: [None],
        self.AttrName.DEPTH_MULTIPLIER: [None],
        self.AttrName.BIAS_TERM: [None],
        self.AttrName.IN_DIM: [None],
        self.AttrName.OUT_DIM: [None],
    }
    ...
    self._attrs[self.AttrName.DEPTH_MULTIPLIER] = NndctIrAttr(
        name=self.AttrName.DEPTH_MULTIPLIER,
        value_type=int,
        size=1,
        value_mem=self._attr_value_mem[self.AttrName.DEPTH_MULTIPLIER],
        occurence_type=OccurenceType.OPTIONAL,
        default_value=1,
        annotation=r"""group""")
...
class PadNd(Operation):
  ...
  def __init__(self) -> None:
    super().__init__(NNDCT_OP.PAD_ND)
    # allocate memory for attr value
    self._attr_value_mem = {
        self.AttrName.PAD_WITH: [],
        self.AttrName.MODE: [None],
        self.AttrName.CONSTANT_VALUES: []
    }
