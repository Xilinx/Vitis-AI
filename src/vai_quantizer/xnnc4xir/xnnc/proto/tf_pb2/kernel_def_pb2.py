...
_KERNELDEF_ATTRCONSTRAINT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="tensorflow.KernelDef.AttrConstraint.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="allowed_values",
            full_name="tensorflow.KernelDef.AttrConstraint.allowed_values",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_KERNELDEF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="op",
            full_name="tensorflow.KernelDef.op",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="device_type",
            full_name="tensorflow.KernelDef.device_type",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="constraint",
            full_name="tensorflow.KernelDef.constraint",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="host_memory_arg",
            full_name="tensorflow.KernelDef.host_memory_arg",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="label",
            full_name="tensorflow.KernelDef.label",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="priority",
            full_name="tensorflow.KernelDef.priority",
            index=5,
            number=6,
            type=5,
            cpp_type=1,
...
_KERNELLIST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="kernel",
            full_name="tensorflow.KernelList.kernel",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_KERNELDEF_ATTRCONSTRAINT.fields_by_name[
    "allowed_values"
...
KernelDef = _reflection.GeneratedProtocolMessageType(
    "KernelDef",
    (_message.Message,),
    dict(
        AttrConstraint=_reflection.GeneratedProtocolMessageType(
            "AttrConstraint",
            (_message.Message,),
            dict(
...
KernelList = _reflection.GeneratedProtocolMessageType(
    "KernelList",
    (_message.Message,),
    dict(
