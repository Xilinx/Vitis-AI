...
_INTERCONNECTLINK = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="device_id",
            full_name="tensorflow.InterconnectLink.device_id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="type",
            full_name="tensorflow.InterconnectLink.type",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="strength",
            full_name="tensorflow.InterconnectLink.strength",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
_LOCALLINKS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="link",
            full_name="tensorflow.LocalLinks.link",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_DEVICELOCALITY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="bus_id",
            full_name="tensorflow.DeviceLocality.bus_id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="numa_node",
            full_name="tensorflow.DeviceLocality.numa_node",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="links",
            full_name="tensorflow.DeviceLocality.links",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_DEVICEATTRIBUTES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="tensorflow.DeviceAttributes.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="device_type",
            full_name="tensorflow.DeviceAttributes.device_type",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="memory_limit",
            full_name="tensorflow.DeviceAttributes.memory_limit",
            index=2,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="locality",
            full_name="tensorflow.DeviceAttributes.locality",
            index=3,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="incarnation",
            full_name="tensorflow.DeviceAttributes.incarnation",
            index=4,
            number=6,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="physical_device_desc",
            full_name="tensorflow.DeviceAttributes.physical_device_desc",
            index=5,
            number=7,
            type=9,
            cpp_type=9,
...
InterconnectLink = _reflection.GeneratedProtocolMessageType(
    "InterconnectLink",
    (_message.Message,),
    dict(
...
LocalLinks = _reflection.GeneratedProtocolMessageType(
    "LocalLinks",
    (_message.Message,),
    dict(
...
DeviceLocality = _reflection.GeneratedProtocolMessageType(
    "DeviceLocality",
    (_message.Message,),
    dict(
...
DeviceAttributes = _reflection.GeneratedProtocolMessageType(
    "DeviceAttributes",
    (_message.Message,),
    dict(
