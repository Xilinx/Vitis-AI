...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        tensorflow_dot_core_dot_framework_dot_function__pb2.DESCRIPTOR,
        tensorflow_dot_core_dot_framework_dot_versions__pb2.DESCRIPTOR,
    ],
)
...
_GRAPHDEF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="node",
            full_name="tensorflow.GraphDef.node",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="versions",
            full_name="tensorflow.GraphDef.versions",
            index=1,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="version",
            full_name="tensorflow.GraphDef.version",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="library",
            full_name="tensorflow.GraphDef.library",
            index=3,
            number=2,
            type=11,
            cpp_type=10,
...
_GRAPHDEF.fields_by_name[
    "versions"
].message_type = tensorflow_dot_core_dot_framework_dot_versions__pb2._VERSIONDEF
_GRAPHDEF.fields_by_name[
    "library"
].message_type = tensorflow_dot_core_dot_framework_dot_function__pb2._FUNCTIONDEFLIBRARY
