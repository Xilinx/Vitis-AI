...
import tensor_shape_pb2 as tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        tensorflow_dot_core_dot_framework_dot_graph__pb2.DESCRIPTOR,
...
_REMOTEFUSEDGRAPHEXECUTEINFO_TENSORSHAPETYPEPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="dtype",
            full_name="tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto.dtype",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="shape",
            full_name="tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto.shape",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_REMOTEFUSEDGRAPHEXECUTEINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="remote_graph",
            full_name="tensorflow.RemoteFusedGraphExecuteInfo.remote_graph",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="graph_input_node_name",
            full_name="tensorflow.RemoteFusedGraphExecuteInfo.graph_input_node_name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="graph_output_node_name",
            full_name="tensorflow.RemoteFusedGraphExecuteInfo.graph_output_node_name",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="executor_name",
            full_name="tensorflow.RemoteFusedGraphExecuteInfo.executor_name",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="serialized_executor_parameters",
            full_name="tensorflow.RemoteFusedGraphExecuteInfo.serialized_executor_parameters",
            index=4,
            number=5,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="default_graph_input_tensor_shape",
            full_name="tensorflow.RemoteFusedGraphExecuteInfo.default_graph_input_tensor_shape",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="default_graph_output_tensor_shape",
            full_name="tensorflow.RemoteFusedGraphExecuteInfo.default_graph_output_tensor_shape",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
...
_REMOTEFUSEDGRAPHEXECUTEINFO_TENSORSHAPETYPEPROTO.fields_by_name[
    "dtype"
...
_REMOTEFUSEDGRAPHEXECUTEINFO_TENSORSHAPETYPEPROTO.containing_type = (
    _REMOTEFUSEDGRAPHEXECUTEINFO
)
_REMOTEFUSEDGRAPHEXECUTEINFO.fields_by_name[
    "remote_graph"
].message_type = tensorflow_dot_core_dot_framework_dot_graph__pb2._GRAPHDEF
_REMOTEFUSEDGRAPHEXECUTEINFO.fields_by_name[
    "default_graph_input_tensor_shape"
].message_type = _REMOTEFUSEDGRAPHEXECUTEINFO_TENSORSHAPETYPEPROTO
_REMOTEFUSEDGRAPHEXECUTEINFO.fields_by_name[
...
RemoteFusedGraphExecuteInfo = _reflection.GeneratedProtocolMessageType(
    "RemoteFusedGraphExecuteInfo",
    (_message.Message,),
    dict(
        TensorShapeTypeProto=_reflection.GeneratedProtocolMessageType(
