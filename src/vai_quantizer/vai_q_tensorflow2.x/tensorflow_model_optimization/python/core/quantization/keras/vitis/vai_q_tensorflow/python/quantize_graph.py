...
from tensorflow_model_optimization.python.core.quantization.keras.vitis.vai_q_tensorflow.gen_files.vai_wrapper import DecentQCheckGraphWithStringInputs
from tensorflow_model_optimization.python.core.quantization.keras.vitis.vai_q_tensorflow.gen_files.vai_wrapper import DecentQConvertConstantsToVariablesWithStringInputs
from tensorflow_model_optimization.python.core.quantization.keras.vitis.vai_q_tensorflow.gen_files.vai_wrapper import DecentQCreateOptimizedGraphWithStringInputs
from tensorflow_model_optimization.python.core.quantization.keras.vitis.vai_q_tensorflow.gen_files.vai_wrapper import DecentQCreateQuantizeCalibrationGraphWithStringInputs
from tensorflow_model_optimization.python.core.quantization.keras.vitis.vai_q_tensorflow.gen_files.vai_wrapper import DecentQCreateQuantizeTrainingGraphWithStringInputs
from tensorflow_model_optimization.python.core.quantization.keras.vitis.vai_q_tensorflow.gen_files.vai_wrapper import DecentQCreateQuantizeEvaluationGraphWithStringInputs
from tensorflow_model_optimization.python.core.quantization.keras.vitis.vai_q_tensorflow.gen_files.vai_wrapper import DecentQConvertFoldedBatchnormsWithStringInputs
from tensorflow_model_optimization.python.core.quantization.keras.vitis.vai_q_tensorflow.gen_files.vai_wrapper import DecentQCreateQuantizeDeployGraphWithStringInputs
from tensorflow_model_optimization.python.core.quantization.keras.vitis.vai_q_tensorflow.python.utils import *
...
def ConvertConstantsToVariables(input_graph_def, config):
  ...
  with tf.compat.v1.errors.raise_exception_on_not_ok_status() as status:
    output_graph_def_string = DecentQConvertConstantsToVariablesWithStringInputs(
      input_graph_def_string, config.to_string())
