...
class ModelTransformer(object):
  ...
  def _is_custom_layer(layer):
    ...
    vitis_objects = set([
        ...
        'Vitis>FSQuantizer', 'Vitis>MAFSQuantizer', 'Vitis>Pof2SQuantizer',
        'Vitis>TQTQuantizer', 'Vitis>VitisQuantizeConfig',
        'Vitis>NoQuantizeConfig', 'Vitis>VitisQuantize', 'Vitis>VitisSigmoid',
        ...
        'LastValueQuantPosQuantizer', 'LastValueLogThQuantizer', 'FSQuantizer',
        'MAFSQuantizer', 'Pof2SQuantizer', 'TQTQuantizer',
