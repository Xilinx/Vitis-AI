...
vitis_gpu_qs_config = os.path.join(dirname, "vitis_gpu_quantize_strategy.json")


class VitisGPUQuantizeStrategy(VitisQuantizeStrategy):
  """Vitis 8-Bit Float Scale (For GPU) Quantize Strategy."""

  def __init__(self, qs_configs=vitis_gpu_qs_config):
    """Init
