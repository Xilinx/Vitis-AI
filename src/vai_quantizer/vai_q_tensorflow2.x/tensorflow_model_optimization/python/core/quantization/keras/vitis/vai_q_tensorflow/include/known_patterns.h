...
CREATE_PATTERN_CLASS(Gelu)
CREATE_PATTERN_CLASS(FusedLeakyrelu)
CREATE_PATTERN_CLASS(KerasLeakyrelu)
CREATE_PATTERN_CLASS(Dense)
CREATE_PATTERN_CLASS(BatchMatMulTrueDiv)
CREATE_PATTERN_CLASS(BatchMatMul)
