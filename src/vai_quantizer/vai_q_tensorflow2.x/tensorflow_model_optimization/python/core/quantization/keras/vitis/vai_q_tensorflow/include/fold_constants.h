...
#ifndef TENSORFLOW_CONTRIB_DECENT_Q_UTILS_FOLD_CONSTANTS_H_
#define TENSORFLOW_CONTRIB_DECENT_Q_UTILS_FOLD_CONSTANTS_H_
...
#endif  // TENSORFLOW_CONTRIB_DECENT_Q_UTILS_FOLD_CONSTANTS_H_
