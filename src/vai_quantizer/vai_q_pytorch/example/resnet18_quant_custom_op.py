...
# Create your Custom Op:
# 1. Aggregate some operations as a function. The first argument name of this function 
#     should be ctx. The meaning of ctx is the same as that in torch.autograd.Function 
...
class ResNetCustom(ResNet):
  def __init__(self,
               ...
               norm_layer=None):
    super(ResNetCustom, self).__init__(block, layers,num_classes,
               zero_init_residual,
               groups,
               width_per_group,
