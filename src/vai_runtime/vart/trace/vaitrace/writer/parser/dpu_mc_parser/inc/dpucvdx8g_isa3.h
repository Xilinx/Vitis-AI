...
struct Load {
  uint32_t bank_addr : 14, bank_id : 6, dpdby : 4, dpdon : 4, opcode : 4;
  uint32_t jump_write : 10, jump_read : 16, redvered_1 : 6;
  uint32_t block_num : 10, jump_write_endl : 14, redvered_2 : 8;
...
struct Save {
  uint32_t bank_addr : 14, bank_id : 6, dpdby : 4, dpdon : 4, opcode : 4;
  uint32_t jump_read : 10, jump_write : 16, redvered_1 : 6;
  uint32_t length : 10, channel : 12, redvered_2 : 10;
  uint32_t reg_id : 3, reserved0 : 5, const_value : 8, const_en : 1,
      reserved1 : 15;
  uint32_t ddr_addr : 29, redvered_3 : 3;
};
struct ConvInit {
  uint32_t jump_read_endl : 13, shift_cut : 6, tile_en : 1, dpdby : 4,
      dpdon : 4, opcode : 4;
  uint32_t jump_read : 10, shift_bias : 6, kernel_w : 4, kernel_h : 4,
      stride_w : 4, stride_h : 4;
  uint32_t jump_write_endl : 13, stride_offset_out : 3, stride_offset_in : 3,
      act_type : 3, conv_num : 10;
  uint32_t jump_write : 10, tile_owg : 6, tile_ocg : 6, tile_icg : 6,
      stride_out : 4;
  uint32_t jump_read_weights : 9, redvered_1 : 1, ow_offset : 6, ow_iter : 5,
      channel_offset : 5, ic_iter : 6;
  uint32_t jump_read_weights_endl : 13, hsigmoid_in : 4, shift_hsigmoid : 5,
      shift_hswish : 4, redvered_2 : 6;
};
struct Conv {
  uint32_t bank_addr_out : 14, bank_id_out : 6, dpdby : 4, dpdon : 4,
      opcode : 4;
  uint32_t bank_addr_in : 14, bank_id_in : 6, icg_offset : 4, redvered_1 : 8;
  uint32_t bank_addr_in_1 : 14, pad_bottom : 4, pad_top : 4, pad_right : 4,
      pad_left : 4, redvered_2 : 2;
  uint32_t bank_addr_in_2 : 14, bank_addr_weights : 14,
      valid_pixel_parallel : 4;
  uint32_t bank_addr_in_3 : 14, bank_addr_bias : 14, ocg_offset : 4;
};
struct PoolInit {
...
struct Pool {
  uint32_t bank_addr_in : 14, pad_top : 3, pad_left : 3, dpdby : 4, dpdon : 4,
      opcode : 4;
  uint32_t bank_id_in : 6, channel_group : 8, pad_bottom : 3, pad_right : 3,
      length : 10, redvered_1 : 2;
  uint32_t bank_id_out : 6, jump_write_endl : 13, jump_read_endl : 13;
  uint32_t bank_addr_out : 14, bank_addr_in_1 : 14, redvered_2 : 4;
  uint32_t bank_addr_in_2 : 14, bank_addr_in_3 : 14, redvered_3 : 4;
};
struct AluInit {
...
struct DWInit {
  uint32_t jump_read_endl : 12, channel_group : 8, dpdby : 4, dpdon : 4,
      opcode : 4;
  uint32_t jump_read : 10, stride_offset_out : 3, stride_offset_in : 3,
      kernel_w : 4, kernel_h : 4, stride_w : 4, stride_h : 4;
  uint32_t jump_write_endl : 12, redvered_1 : 7, channel_offset : 5,
      act_type : 4, stride_out : 4;
  uint32_t jump_write : 10, length : 10, shift_bias : 6, shift_cut : 6;
};
struct DptWise {
  uint32_t bank_addr_out : 14, bank_id_out : 6, dpdby : 4, dpdon : 4,
      opcode : 4;
  uint32_t bank_addr_in : 14, bank_id_in : 6, redvered_1 : 12;
  uint32_t bank_addr_in_1 : 14, pad_right : 4, pad_left : 4, pad_bottom : 4,
      pad_top : 4, redvered_2 : 2;
  uint32_t bank_addr_in_2 : 14, bank_addr_weights : 14,
      valid_pixel_parallel : 4;
  uint32_t bank_addr_in_3 : 14, bank_addr_bias : 14, redvered_3 : 4;
};
...
std::vector<class inst_desc> inst_table = {
    ...
    create_inst_desc(CONVINIT, 0x09, 6),
    ...
    create_inst_desc(DWINIT, 0x0B, 4),
