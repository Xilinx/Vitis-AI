...
struct Load
{
  ...
  uint32_t bank_addr : 14, bank_id : 6, dpby : 4, dpdon : 4, opcode : 4;
  uint32_t jump_write : 10, jump_read : 16, r0 : 6;
  uint32_t block_num : 10, jump_write_endl : 14, r1 : 8;
...
struct Save
{
  ...
  uint32_t bank_addr : 14, bank_id : 6, dpby : 4, dpdon : 4, opcode : 4;
  uint32_t jump_read : 10, jump_write : 16, r0 : 6;
  uint32_t length : 10, channel : 12, r1 : 10;
  uint32_t reg_id : 3, r3 : 5, const_value : 8, const_en : 1, r2 : 15;
  uint32_t ddr_addr : 29, r4 : 3;
};

std::vector<class inst_desc> inst_table = {
    create_inst_desc (LOAD, 0b0000, 6),
